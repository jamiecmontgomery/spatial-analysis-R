...
**(1) The first thing we need to do is eliminate all cells in both our SST and OA layers that fall outside of our species environmental range**
...
cc_ras = rasterize(cc,sstAvg)#,progress='text')
cc_ras
...
cc_ras_ID = rasterize(cc,sstAvg,field="ID");cc_ras_ID
plot(cc_ras_ID)
